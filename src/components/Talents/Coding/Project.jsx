...
export default function ShowcaseProject({ name, techPoints, vidSrc, imgSrc, blurSrc, link, infoLink }) {
    return (
        <>
            <FadeIn>
                <h3 className="lg:hidden mt-8 font-bold text-shine-purple text-4xl text-center">{name}</h3>
            </FadeIn>
            <FadeIn>
                <h3 className="hidden lg:block mt-8 font-bold text-shine-purple text-4xl text-left">PROJECT - {name}</h3>
            </FadeIn>
